    ...
    <section className={`overflow-hidden rounded-lg border border-border bg-card shadow-xl ${className}`} aria-labelledby="office-location-heading">
      <div className="grid lg:grid-cols-[.85fr_1.15fr]">
        <div className="flex flex-col justify-center p-6 sm:p-8 lg:p-10">
          <p className="text-sm font-semibold uppercase tracking-[.14em] text-brand-green">Visit our office</p>
          ...
          <div className="mt-6 space-y-4 text-sm leading-6 text-muted-foreground">
            <p className="flex gap-3"><MapPin className="mt-1 h-4 w-4 shrink-0 text-brand-green" /><span>153, Pili Market, Near Ram Lal Marriage Lawn, Narouna, Kakori Mod, Mohan Road, Lucknow, Uttar Pradesh - 227107</span></p>
            <a href="tel:+919872133840" className="flex w-fit items-center gap-3 transition hover:text-brand-green"><Phone className="h-4 w-4 text-brand-green" />+91 98721 33840</a>
            <a href="mailto:info@visionsecuretech.in" className="flex w-fit items-center gap-3 transition hover:text-brand-green"><Mail className="h-4 w-4 text-brand-green" />info@visionsecuretech.in</a>
          </div>
