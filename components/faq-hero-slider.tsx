...
export function FAQHeroSlider() {
  ...
  size="lg"
  variant="outline"
  className="rounded-full border-accent/40 bg-accent/10 px-8 text-brand-green backdrop-blur-md transition-all duration-300 hover:scale-105 hover:bg-accent/20 hover:border-accent"
  asChild
>
  <a
  ...
  >
    <FaWhatsapp className="mr-2 h-5 w-5 text-brand-green transition-transform duration-300 group-hover:scale-110" />
    WhatsApp Support
  </a>
</Button>
